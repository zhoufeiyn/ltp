...
class ConfigDF():
    ...
    def __init__(self, model_name=None):
        ...
        # model arch params
        self.use_dit = 'dit' in model_name #True
        self.use_mario = 'mario' in model_name #True
        self.use_km = 'km' in model_name #True
        self.use_tanh = 'tanh' in model_name #True
        self.use_lrelu = 'lrelu' in model_name  # False
        self.use_mc = 'mc' in model_name # False
        ...
        # fix params
        self.world_model_action_num = 46 # Mario游戏中有46种不同的有效动作
        self.player_num = 1
